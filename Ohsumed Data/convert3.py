...
input1 = open("lowert/class-1/class-1_lower.txt","r")
input1 = input1.read()
input1 = input1.split("\n")
...
input2 = open("lowert/class-2/class-2_lower.txt","r")
input2 = input2.read()
input2 = input2.split("\n")
...
input3 = open("lowert/class-3/class-3_lower.txt","r")
input3 = input3.read()
input3 = input3.split("\n")
...
input4 = open("lowert/class-4/class-4_lower.txt","r")
input4 = input4.read()
input4 = input4.split("\n")
...
#############
input5 = open("lowert/class-5/class-5_lower.txt","r")
input5 = input5.read()
input5 = input5.split("\n")
...
input6 = open("lowert/class-6/class-6_lower.txt","r")
input6 = input6.read()
input6 = input6.split("\n")
...
input7 = open("lowert/class-7/class-7_lower.txt","r")
input7 = input7.read()
input7 = input7.split("\n")
...
input8 = open("lowert/class-8/class-8_lower.txt","r")
input8= input8.read()
input8 = input8.split("\n")
...
input10 = open("lowert/class-10/class-10_lower.txt","r")
...
input11 = open("lowert/class-11/class-11_lower.txt","r")
...
#############
input12 = open("lowert/class-12/class-12_lower.txt","r")
...
input13 = open("lowert/class-13/class-13_lower.txt","r")
...
input14 = open("lowert/class-14/class-14_lower.txt","r")
...
input15 = open("lowert/class-15/class-15_lower.txt","r")
...
input16 = open("lowert/class-16/class-16_lower.txt","r")
...
input17 = open("lowert/class-17/class-17_lower.txt","r")
...
input18 = open("lowert/class-18/class-18_lower.txt","r")
...
#############
input19 = open("lowert/class-19/class-19_lower.txt","r")
...
input20 = open("lowert/class-20/class-20_lower.txt","r")
...
input21 = open("lowert/class-21/class-21_lower.txt","r")
...
input22 = open("lowert/class-22/class-22_lower.txt","r")
...
input23 = open("lowert/class-23/class-23_lower.txt","r")
...
compositefile = open("composite2test.txt","w")
